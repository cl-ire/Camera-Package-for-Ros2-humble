...
setup(
    ...
    data_files=[
        ...
        (os.path.join('share', package_name, 'launch'), glob(os.path.join('launch', '*launch.[py][yma]*'))),
    ...
    entry_points={
        'console_scripts': [
            ...
            'camera_opencv_loop2 = camera_package.camera_opencv_loop2_node:main',
            ...
            'movement_control_util = camera_package.movement_control_util:main',
